...
def stage_delivery(limit: int | None = None) -> dict[str, Any]:
    ...
    group_cooldown_hours = _rule_int(action, 'group_cooldown_hours', 'broadcast_cooldown_grup_jam', 24)
    group_cooldown_minutes = _rule_int(action, 'group_cooldown_minutes', 'broadcast_cooldown_grup_menit', 0)
